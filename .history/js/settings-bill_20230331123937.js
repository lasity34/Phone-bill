...
// settings updated
const callValue = callCostSettingEl.value || 2.75;
const smsValue = smsCostSettingEl.value || 0.75;
const warningValue = warningSettingEl.value || ''; 
const cricitcalValue = criticalLevelSettingEl.value || '';
